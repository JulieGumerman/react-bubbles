...
- [x] Explain what a token is used for.
  ...
  _A token is your password, only encrypted, and it is used to verify that you really are you when you log in._


- [x] What steps can you take in your web apps to keep your data secure?

  _Most of that happens on the back end of things. However, React developers can create private routes that ensure that only users with valid tokens can access those routes; everyone else will be redirected to a login or sign-in page._


- [x] Describe how web servers work.

  _Web servers tell physical servers what to do! When a user types in a web address, web servers ind the server with that code and returns the info to the users_


- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

The methods are Create, Read, Update, and Delete.
